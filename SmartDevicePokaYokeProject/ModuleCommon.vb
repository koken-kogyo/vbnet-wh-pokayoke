...
Module ModuleCommon
    ...
    ' Bluetoothラベルプリンタ
    Public aryPrinterName() As String = Split("1:酸洗梱包,2:炉中洩検(1階),3:建機工程,4:技術(2階)", ",")
    ...
    Public Function SPPConnect(ByVal myPrinter As Int32) As Int32
        Dim ret As Int32 = 0
        Dim disp As [String] = ""
        ...
        Try
            ...
            stInfoSet.addr = aryBRAddress(myPrinter)
            stInfoSet.name = aryDeviceName(myPrinter)
    ...
    Public Function SPPSend(ByVal iHMCD As String, ByVal iQTY As String, ByVal iTEMP As String) As Int32
        ...
        Try
            ...
            strSendBuf = "^TS" & tempparm & "^SS01,^CN" & qtyparm & iHMCD & "," & iHMCD & "," & iHMCD & ",^FF"
